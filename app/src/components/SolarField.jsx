...
export default function SolarField({ count, panelSpecs }) {
  ...
  return (
    <Canvas camera={{ position: [0, 30, 45], fov: 50 }} style={{ background: "#1e293b" }}>
      ...
      {/* Terreno de césped verde expansible centrado en el origen */}
      <mesh rotation={[-Math.PI / 2, 0, 0]} position={[0, -0.01, 0]}>
        <planeGeometry args={[gridSize + 40, gridSize + 40]} />
        <meshStandardMaterial color="#4ade80" roughness={0.7} />
      </mesh>

      {/* Grilla estándar fija de 10m x 10m centrada */}
      <gridHelper 
        args={[
          gridSize,
          gridSize / 10,
      ...
      {/* Referencia central: Torre de 30m y humano dentro de su terreno de 10x10m */}
